 ...
 */
public class TeacherSignIn extends AppCompatActivity implements View.OnClickListener{

    private final AppCompatActivity activity = TeacherSignIn.this;
    ...
    private void initViews() {
        ...
        nestedScrollView = (NestedScrollView) findViewById(R.id.nestedScrollViewts);

        textInputLayoutTUserId = (TextInputLayout) findViewById(R.id.textInputLayoutTeacherReLogin);
        textInputLayoutTPassword = (TextInputLayout) findViewById(R.id.textInputLayoutTeacherRePassword);

        textInputEditTextTeacherUserId = (TextInputEditText) findViewById(R.id.textInputEditTextTeacherReLogin);
    ...
    public void verifyFromSQLiteTeacher() {
        ...
        if (TeacherDatabase.checkTeacher(textInputEditTextTeacherUserId.getText().toString().trim(),textInputEditTextTeacherPassword
            ...
            TeacherLD();
            Intent accountsIntent = new Intent(activity, AttendanceDetails.class);
